...
function getRandomShellSize() {
    ...
    const height =
        maxVariance === 0 ? Math.random() : 1 - variance / maxVariance;
...
class Shell {
    ...
    burst(x, y) {
        ...
        if (typeof this.color === "string") {
            ...
            if (this.ring) {
                ...
                createParticleArc(0, PI_2, this.starCount, 0, (angle) => {
                    ...
                    // Rotate ring
                    const newSpeed = MyMath.pointDist(
                        0,
                        0,
                        initSpeedX,
                        initSpeedY
                    ...
                    const newAngle =
                        MyMath.pointAngle(0, 0, initSpeedX, initSpeedY) +
                        ringStartAngle;
                    const star = Star.add(
                        x,
                        y,
        ...
        if (this.comet) {
            ...
            const soundScale =
                (1 - sizeDifferenceFromMaxSize / maxDiff) * 0.3 + 0.7;
